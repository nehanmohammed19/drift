...
function updateMetricsDisplay() {
    ...
    if (clickTimes.length > 1) {
        ...
        document.getElementById('avgTime').textContent = (avgInterval / 1000).toFixed(2) + 's';
    }
    
    // Click accuracy (placeholder - would need more complex tracking)
    document.getElementById('accuracy').textContent = '95%'; // Simplified for now
